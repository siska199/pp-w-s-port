...
export const SocialLinkContextProvider = (props: { children: React.ReactNode }) => {
  const { children } = props
  const [state, dispatch] = useReducer(reducer, initialValue)
  return (
    <socialLinkContext.Provider value={{ state, dispatch }}>{children}</socialLinkContext.Provider>
  )
}
