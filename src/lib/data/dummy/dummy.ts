...
export const skills = [
    ...
    },
    {
        ...
        level: 'Advanced',
        projects: ['API for Social Media App', 'Real-time Chat Application', 'Microservices for E-commerce'],
    },
    {
        id: '3',
        name: 'Figma',
        ...
        level: 'Beginner',
        projects: ['Mobile App Design for Fintech', 'Landing Page Wireframe', 'Prototyping for Web Application'],
    },
    {
        id: 4,
        name: 'PostgreSQL',
        ...
        years_of_experience: 3,
        level: 'Intermediate',
        projects: ['Customer Management System', 'Data Warehousing Solution', 'Analytics Dashboard'],
    },
    {
        id: 5,
        name: 'Docker',
        ...
        years_of_experience: 2,
        level: 'Intermediate',
        projects: ['Containerized Microservices', 'CI/CD Pipeline Setup', 'Development Environment Automation'],
    },
    {
        id: 6,
        name: 'AWS',
        ...
        years_of_experience: 4,
        level: 'Advanced',
        projects: ['Serverless Application', 'S3 Data Storage for Video Platform', 'Lambda Functions for Processing Data'],
    },
    {
        id: 7,
        name: 'Jest',
        ...
        years_of_experience: 2,
        level: 'Intermediate',
        projects: ['Unit Testing for React App', 'End-to-End Testing for Web App', 'Test Coverage for Backend Services'],
    },
    {
        id: 8,
        name: 'JavaScript',
        ...
        level: 'Advanced',
        projects: ['Interactive Web Game', 'Single Page Application', 'Custom Web Components'],
    },
    {
        id: 9,
        name: 'Django',
        ...
        years_of_experience: 3,
        level: 'Intermediate',
        projects: ['Content Management System', 'RESTful API for Healthcare App', 'E-commerce Backend'],
    },
    {
        id: 10,
        name: 'MongoDB',
        ...
        years_of_experience: 2,
        level: 'Beginner',
        projects: ['NoSQL Database for Social Media', 'Document-based Data Storage', 'Data Handling for Real-time App'],
    },
];
...
export const projects = [
    ...
    },
    {
        ...
        tech_stacks: ['React', 'Zustand', 'Chart.js', 'React-Select', 'Axios', 'React-Router-DOM'],
    },
    {
        id: 3,
        ...
        tech_stacks: ['Nuxt.js', 'TypeScript', 'Vuex', 'Tailwind CSS', 'vue-drag-resize'],
    },
    {
        id: 4,
        ...
        tech_stacks: ['Vite', 'React', 'TypeScript', 'Redux Toolkit', 'Material UI', 'Python Django', 'PostgreSQL'],
    },
    {
        id: 5,
...
export const experiances = [
    ...
    },
    {
        ...
        endDate: '2023-08-14',
        description: 'Led the development of frontend and backend systems for various applications, focusing on scalability and maintainability.',
    ...
    },
    {
        ...
        endDate: '2023-11-30',
        description: 'Assisted in the development of web applications using React and contributed to the design of user interfaces.',
    ...
    },
    {
        ...
        endDate: '2022-11-15',
        description: 'Developed and maintained responsive web applications, focusing on performance and user experience.',
    ...
    },
    {
        ...
        endDate: '2021-04-30',
        description: 'Engaged in full-stack development, primarily working on client-side features and optimizing backend processes.',
...
export const categoriesSocialLink = [
    {
        ...
        value: JSON.stringify({
            name: 'Github',
            image: 'https://res.cloudinary.com/dkig5fihk/image/upload/v1729247400/social-link/ooqkntkp2tktrx6j2hxn.png',
    ...
    },
    {
        ...
        value: JSON.stringify({
            name: 'Linkeind',
            image: 'https://res.cloudinary.com/dkig5fihk/image/upload/v1729247498/social-link/xdzhglvhtgvf47et6b6z.png',
    ...
    },
    {
        ...
        value: JSON.stringify({
            name: 'Gmail',
            image: 'https://res.cloudinary.com/dkig5fihk/image/upload/v1729247780/social-link/t3cnxt2m6r7ztg5mkdib.png',
            placeholder: 'https://mail.google.com/mail/u/0/?fs=1&to=siska.apriana.rifianti199@gmail.com&tf=cm',
            defaultValue: 'https://mail.google.com/mail/u/0/?fs=1&to=<your_gmail>&tf=cm',
        }),
    },
    {
        label: 'WhatsApp',
        value: JSON.stringify({
            name: 'WhatsApp',
            image: 'https://res.cloudinary.com/dkig5fihk/image/upload/v1729247780/social-link/bxhkbwtmgmqublxipjdw.png',
