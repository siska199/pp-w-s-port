...
import { handleSetAlertConfig, handleSetModal, handleSetModalConfirmation, initialStateUISlice } from '@store/ui-slice';
            ...
            <ModalConfirmation
                ...
                button={{
                    ...
                    cancel: {
                        ...
                        onClick: () => dispatch(handleSetModalConfirmation({ ...initialStateUISlice?.modalConfirmation })),
                    },
                }}
            />
            <ContainerModal
