...
import experianceSchema, { initialFormExperiance, TFormExperiance } from "@lib/validation/module/experiance/experiance-schema"
...
const FormExperiance = () => {
  ...
  useEventEmitter(EVENT_NAME_EXPERIANCE.SET_MODAL_FORM_EXPERIANCE, (data) => {
    setModalForm({ ...data })
  })

  useEventEmitter(EVENT_NAME_EXPERIANCE.SET_EXPERIANCE, (data) => {
