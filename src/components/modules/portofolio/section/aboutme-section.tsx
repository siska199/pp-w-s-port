    ...
    <ContainerSection title="About Me">
      ...
      >
        <motion.div
          ...
          className="flex flex-col flex-grow min-w-[20rem] gap-2"
        >
        ...
        <motion.p
          ...
          className="indent-16 md:text-body-large h-auto my-auto p-4 rounded-md bg-card-transparent"
        >
          {aboutMeData.aboutMe}
        </motion.p>
      </Container>
...
const CardExperienceMetric = (props: TPropsCardExperienceMetric) => {
  ...
  return (
    <Container
      variant={'hsc'}
      className="  bg-glass-animation rounded-lg p-4 gap-8 md:gap-2"
    >
