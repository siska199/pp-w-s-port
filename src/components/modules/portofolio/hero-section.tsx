  ...
  return <div className=" min-h-[calc(100%)] flex flex-col-reverse md:flex-row items-center justify-center gap-8 pt-[5rem] md:mt-0 px-2">
    <div className="gap-2 flex flex-col justify-center h-full ">
     ...
     <div className=" hidden md:flex w-full md:w-auto">
        <Image className="image-animation-float md:clip-path-hero-img mx-auto rounded-full md:rounded-none w-[10rem] md:w-[25rem] aspect-square bg-transparent" src="dummy-images/profesional-image.jpg"/>
    </div> 
</div>;
};
