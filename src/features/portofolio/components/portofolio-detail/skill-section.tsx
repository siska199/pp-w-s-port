...
const CardItemSkill = (props: TCardItemSkill) => {
    ...
    return (
        <motion.div key={name} {...cardAnimation({ index })} className=" bg-card-transparent  flex gap-4 items-center md:w-[12rem] md:max-w-[12rem] md:min-w-[12rem] p-4 rounded-md">
            <Image src={url} className="w-10 md:w-[3.5rem] flex-shrink-0 aspect-square rounded-full shadow-2xl" />
