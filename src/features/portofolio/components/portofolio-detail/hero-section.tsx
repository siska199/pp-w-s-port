    ...
    return (
        <ContainerSection ref={ref} gap="xl" className="mt-10 md:mt-0  h-screen !p-8">
            <Container gap="base" className="w-auto ">
                ...
                <AnimatedText text={`SOFTWARE ENGINEER`} className="font-bubblegum-sans text-center md:text-start" />
                ...
                <motion.div {...opacityAnimation()}>
                    <Container variant={'vcc'} className="md:items-start" gap="base">
                        <AnimatedText text={`Sharp Thinking and Seamless Coding, Powered by Coffee ☕`} className="ml-1 text-center md:text-start italic text-body-large font-normal " />
