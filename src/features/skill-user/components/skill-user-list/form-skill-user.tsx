...
import skillUserSchema, { initialFormSkillUser, TOptionsFormSkillUser, TSkillUserSchema } from '@features/skill-user/validation/skill-user-schema';
...
const FormSkillUser = () => {
    ...
    const handleOnChange = (e: TEventOnChange) => {
        ...
        if (name === 'id_category') {
            currForm['id_skill'].options = options['skills']?.filter((data: any) => data?.id_category === value);
