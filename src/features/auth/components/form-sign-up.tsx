...
import signUpSchema, { initialFormSignUp, TSignUpSchema } from '@features/auth/validations/sign-up-schema';
...
import { deepCopy, extractValueFromForm, filterKeysObject, generateOptions, mappingErrorsToForm } from '@lib/helper/function';
    ...
    return (
        <Container variant={'vcc'} gap="base" className={` flex-nowrap `}>
            ...
            <p className="mx-auto">
                ...
                <Button type="link" variant={'link-white'} className="underline" to={`${pathname}?type=sign-in`} onClick={(e) => e?.stopPropagation()}>
                    Sign In
                </Button>{' '}
            </p>
        </Container>
