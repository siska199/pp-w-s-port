...
export const messageError = {
    ...
    maxCharacter: (name: string, maxCharacter: number) => `${name} must not exceed ${maxCharacter} characters.`,
    minCharacter: (name: string, maxCharacter: number) => `${name} must have at least ${maxCharacter} characters.`,
