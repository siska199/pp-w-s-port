...
interface TProps<TData extends object, TIncludeChecked extends boolean = false> {
    ...
    onFetchData: <TObject extends object>(params: TSettingTable<TData> & TObject) => Promise<TResponseDataPaginationAPI<TData>>;
}

const useTable = <TData extends object, TIncludeChecked extends boolean = false>(
    props: TProps<TData, TIncludeChecked> & Omit<TTableProps<TData, TIncludeChecked>, 'setting' | 'data' | 'columns' | 'settings' | 'onChange' | 'setData'>,
) => {
